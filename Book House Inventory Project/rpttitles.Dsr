VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rpttitles 
   Bindings        =   "rpttitles.dsx":0000
   Caption         =   "Titles"
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "rpttitles.dsx":0014
   ...
   EndProperty
End
Attribute VB_Name = "rpttitles"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_QueryClose(Cancel As Integer, CloseMode As Integer)
    Data1.rsrpttitles.Close
End Sub
